...
public class Offre {
	...
	public Offre(int capacite, String date_arrive, String date_depart, double prix, Long chambreId, Long hotelId, String image, int etoileHotel, String nomHotel, String ville) {
		setImage(image);
		setCapacite(capacite);
		setDate_arrive(LocalDate.parse(date_arrive));
		setDate_depart(LocalDate.parse(date_depart));
		setPrix(prix);
		setHotelId(hotelId);
		setChambreId(chambreId);
		setEtoileHotel(etoileHotel);
